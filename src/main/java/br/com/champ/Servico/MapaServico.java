    ...
    public List<Mapas> pesquisar() throws Exception {
     ...
     public Mapas pesquisarMapa(Long id) {
        try {
            ...
            Mapas userArray = gson.fromJson(response.toString(), Mapas.class);
      ...
      public Mapas save(Mapas mapa, Long id, String uri) throws Exception {
